...
int main(int argc, char* argv[])
{
    ...
    for(i = 1; i<=dim; i++) {
	  ...
	  cudaCheckReturn(cudaMalloc((void **) &dev_grid, (258) * (258) * sizeof(int)));
	  cudaCheckReturn(cudaMalloc((void **) &dev_newGrid, (257) * (258) * sizeof(int)));
	  
	  cudaCheckReturn(cudaMemcpy(dev_grid, grid, (258) * (258) * sizeof(int), cudaMemcpyHostToDevice));
...
// Result in console: "Total Alive: 3281"
