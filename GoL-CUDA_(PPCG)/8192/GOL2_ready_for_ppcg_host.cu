...
int main(int argc, char* argv[])
{
    ...
    for(i = 1; i<=dim; i++) {
	  ...
	  cudaCheckReturn(cudaMalloc((void **) &dev_grid, (8194) * (8194) * sizeof(int)));
	  cudaCheckReturn(cudaMalloc((void **) &dev_newGrid, (8193) * (8194) * sizeof(int)));
	  
	  cudaCheckReturn(cudaMemcpy(dev_grid, grid, (8194) * (8194) * sizeof(int), cudaMemcpyHostToDevice));
...
// Result in console: "Total Alive: 2896683"
