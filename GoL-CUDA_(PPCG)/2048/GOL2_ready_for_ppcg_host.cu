...
int main(int argc, char* argv[])
{
    ...
    for(i = 1; i<=dim; i++) {
	  ...
	  cudaCheckReturn(cudaMalloc((void **) &dev_grid, (2050) * (2050) * sizeof(int)));
	  cudaCheckReturn(cudaMalloc((void **) &dev_newGrid, (2049) * (2050) * sizeof(int)));
	  
	  cudaCheckReturn(cudaMemcpy(dev_grid, grid, (2050) * (2050) * sizeof(int), cudaMemcpyHostToDevice));
...
// Result in console: "Total Alive: 182485"
