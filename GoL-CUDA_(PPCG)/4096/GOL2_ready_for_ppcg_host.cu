...
int main(int argc, char* argv[])
{
    ...
    for(i = 1; i<=dim; i++) {
	  ...
	  cudaCheckReturn(cudaMalloc((void **) &dev_grid, (4098) * (4098) * sizeof(int)));
	  cudaCheckReturn(cudaMalloc((void **) &dev_newGrid, (4097) * (4098) * sizeof(int)));
	  
	  cudaCheckReturn(cudaMemcpy(dev_grid, grid, (4098) * (4098) * sizeof(int), cudaMemcpyHostToDevice));
...
// Result in console: "Total Alive: 724393"
