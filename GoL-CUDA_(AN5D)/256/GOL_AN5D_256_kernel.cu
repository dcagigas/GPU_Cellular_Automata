...
__device__ int __sbref_wrap(int *sb, size_t index) { return sb[index]; }

__global__ void kernel0_4(int *grid, int *rule_table, int c0)
{
#ifndef AN5D_TYPE
#define AN5D_TYPE unsigned
    ...
    int __reg_3_1;
    int __reg_3_2;
    __shared__ int __a_sb_double[__blockSize * 2];
    int *__a_sb = __a_sb_double;
    __shared__ int __b_sb_double[__blockSize * 2];
    int *__b_sb = __b_sb_double;
    __shared__ int __c_sb_double[__blockSize * 2];
    int *__c_sb = __c_sb_double;
...
__global__ void kernel0_3(int *grid, int *rule_table, int c0)
{
#ifndef AN5D_TYPE
#define AN5D_TYPE unsigned
#endif
...
__global__ void kernel0_2(int *grid, int *rule_table, int c0)
{
#ifndef AN5D_TYPE
#define AN5D_TYPE unsigned
#endif
...
__global__ void kernel0_1(int *grid, int *rule_table, int c0)
{
#ifndef AN5D_TYPE
#define AN5D_TYPE unsigned
#endif
