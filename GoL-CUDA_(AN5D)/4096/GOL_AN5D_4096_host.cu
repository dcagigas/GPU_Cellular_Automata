...
#define cudaCheckKernel() \
  do { \
    cudaCheckReturn(cudaGetLastError()); \
      ...
      cudaCheckReturn(cudaMalloc((void **) &dev_grid, (size_t)(2) * (size_t)(4098) * (size_t)(4098) * sizeof(int)));
      cudaCheckReturn(cudaMalloc((void **) &dev_rule_table, (size_t)(2) * (size_t)(9) * sizeof(int)));
      
{
      cudaCheckReturn(cudaMemcpy(dev_grid, grid, (size_t)(2) * (size_t)(4098) * (size_t)(4098) * sizeof(int), cudaMemcpyHostToDevice));
#ifdef STENCILBENCH
...
SB_STOP_INSTRUMENTS;
#endif
      cudaCheckReturn(cudaMemcpy(grid, dev_grid, (size_t)(2) * (size_t)(4098) * (size_t)(4098) * sizeof(int), cudaMemcpyDeviceToHost));
}
